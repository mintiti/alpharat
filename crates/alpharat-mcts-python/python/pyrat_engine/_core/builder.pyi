...
class PyGameConfigBuilder:
    ...
    def with_player1_pos(self, pos: Coordinates | tuple[int, int]) -> PyGameConfigBuilder: ...
    def with_player2_pos(self, pos: Coordinates | tuple[int, int]) -> PyGameConfigBuilder: ...
