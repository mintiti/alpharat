"""Loss function for CNN architecture."""
...
from alpharat.nn.architectures.cnn.config import CNNOptimConfig  # noqa: TC001
...
def compute_cnn_losses(
    ...
    Same loss structure as SymmetricMLP - both use structural symmetry.
